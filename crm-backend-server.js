...
app.post('/api/patients', async (req, res) => {
  ...
  try {
    ...
    await client.query(`
      ...
      (id, patient_id, program_id, points_balance, lifetime_points, tier, created_at)
      VALUES 
      (gen_random_uuid(), $1, gen_random_uuid(), 100, 100, 'bronze', NOW())
    `, [patientId]);
...
app.post('/api/appointments', async (req, res) => {
  ...
  try {
    ...
    const { 
      ...
      appointment_time, appointment_type, reason, notes 
    } = req.body;
    ...
    const result = await client.query(`
      ...
      (id, patient_id, hospital_id, doctor_id, appointment_date, 
       appointment_time, appointment_type, status, reason, notes, created_at)
      VALUES 
      ($1, $2, $3, $4, $5, $6, $7, 'scheduled', $8, $9, NOW())
      RETURNING *
    `, [appointmentId, patient_id, hospital_id, doctor_id, 
        appointment_date, appointment_time, appointment_type || 'consultation',
        reason, notes]);
    ...
    await client.query(`
      ...
      VALUES 
      (gen_random_uuid(), $1, '24_hours', $2::date - INTERVAL '1 day', 
       $3, 'sms', 'pending', NOW())
    `, [appointmentId, appointment_date, appointment_time]);
